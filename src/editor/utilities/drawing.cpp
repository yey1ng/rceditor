...
void ax::Drawing::DrawIcon(ImTextureID i_ID, ImDrawList* drawList)
{
    drawList->AddImage(i_ID, ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 96));
}
