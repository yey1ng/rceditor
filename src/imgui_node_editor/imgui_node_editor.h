...
enum StyleColor
{
    ...
    StyleColor_SingleLink,
    StyleColor_MultipleLink,
	StyleColor_Readable,
	StyleColor_Writable,
...
struct Style
{
    ...
    Style()
    {
        ...
        Colors[StyleColor_SingleLink]         = ImColor(237,  34,  36, 255);
        Colors[StyleColor_MultipleLink]       = ImColor(118, 185,   0, 255);
		Colors[StyleColor_Readable]           = ImColor(237,  34,  36, 255);
		Colors[StyleColor_Writable]           = ImColor(118, 185,  0, 255);
    }
};
...
Config& GetConfig(EditorContext* ctx = nullptr);
...
void SaveData(rceditor::NodeManager* i_NodeManager);
void LoadData(rceditor::NodeManager* i_NodeManager);
...
//
//inline uint32_t IDToU32(NodeId i_Id)
//{
//    char l_Buffer[65] = "";
//    snprintf(l_Buffer, 65, "%d", i_Id.AsPointer());
//    uint32_t l_ID = 0;
//    sscanf(l_Buffer, "%u", &l_ID);
//    return l_ID;
//}
//
//inline uint32_t IDToU32(LinkId i_Id)
//{
//    char l_Buffer[65] = "";
//    snprintf(l_Buffer, 65, "%d", i_Id.AsPointer());
//    uint32_t l_ID = 0;
...
//}
//
//inline uint32_t IDToU32(PinId i_Id)
//{
//    char l_Buffer[65] = "";
//    snprintf(l_Buffer, 65, "%d", i_Id.AsPointer());
//    uint32_t l_ID = 0;
