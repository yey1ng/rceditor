...
# include <application/public/setup.h>
# include <application/public/platform.h>
# include <application/public/renderer.h>
...
void Application::RecreateFontAtlas()
{
    ...
    m_DefaultFont = io.Fonts->AddFontFromFileTTF("data/LXGWWenKai-Regular.ttf", 18.0f, &config, io.Fonts->GetGlyphRangesChineseSimplifiedCommon());
    m_HeaderFont = io.Fonts->AddFontFromFileTTF("data/LXGWWenKai-Regular.ttf", 20.0f, &config, io.Fonts->GetGlyphRangesChineseSimplifiedCommon());
